    ...
    >
      ...
      >
        {({ isEntering, isExiting }) => (
          <div
            className={cx(
              'origin-(--trigger-anchor-point) bg-primary-solid z-50 flex max-w-xs flex-col items-start gap-1 rounded-lg px-3 shadow-lg will-change-transform',
